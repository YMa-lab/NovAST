...
### remove conv1, just 1 layer GCN, feat here is original features, output is what after GCN
...
### out_feat is after GCN, two linear layer for shared class and total class separately (what is that for)
...
###  seems no different as the previous one
...
### separate classfier for shared & total (how to define shared here)
