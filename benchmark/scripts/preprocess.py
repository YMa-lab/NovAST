...
def preprocess(adata_reference, adata_target, filedic_reference, filedic_target, hvg=None, target_sum=1e4):
    ...
    # # If both preprocessed files exist, load and return them without doing any processing
    # if os.path.exists(output_path_reference) and os.path.exists(output_path_target):
    #     adata_reference_subset = sc.read_h5ad(output_path_reference)
    #     adata_target_subset = sc.read_h5ad(output_path_target)
